...
aws ecs create-service \
    ...
    --service-name $METRIC_SERVICE_NAME \
    ...
    --load-balancers "targetGroupArn=$METRIC_TARGET_GROUP_ARN,containerName=$METRIC_APP_NAME,containerPort=8000" \
